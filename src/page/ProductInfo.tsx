...
const ProductDetails: React.FC = () => {
  ...
  const mediaItems = [
    ...product.images,
    ...(product.product_video && product.product_video.includes("youtube.com") ? [product.product_video] : []),
  ]
      ...
      <div className="max-w-5xl mx-auto overflow-hidden">
        ...
        <div className="flex flex-col gap-6 p-4 md:flex-row">
            ...
            {mediaItems.map((media, index) => (
              <button
                ...
                className={`w-full h-24 overflow-hidden transition-opacity border shadow hover:opacity-80 ${
                  selectedMedia === media ? "border-orange-500 border-2" : "border-gray-200"
                }`}
              >
          ...
          <div className="w-full p-10 border border-gray-100 rounded shadow-sm md:w-1/3 bg-gray-50">
            ...
            <p className="mt-4 text-3xl font-bold text-gray-900">${product.price.toLocaleString()}</p>
            <p className="mt-4 text-gray-600">{product.description.substring(0, 100)}...</p>
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="px-4 py-1 border rounded-md min-w-[40px] text-center">{quantity}</span>
                <button
