      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-2 sm:inset-x-4 top-16 sm:top-20 bottom-16 sm:bottom-20 md:inset-auto md:top-[5%] md:left-[35%] md:max-w-lg w-full md:-translate-x-[50%] bg-white rounded-xl shadow-xl overflow-hidden z-50 flex flex-col max-h-[85vh] md:max-h-[85vh]"
          >
