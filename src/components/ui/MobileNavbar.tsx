  ...
  return (
    <section className="w-full max-w-[264px]">
      <Sheet>
        ...
        <SheetContent side="left" className="bg-[#F3F4F6] border-none gap-1 text-black">
          {/* Logo and Initials */}
          <div className="flex items-center justify-between">
            <Link to="/" className="z-10 flex items-center gap-1">
              <img src="https://mbaaysite-6b8n.vercel.app/assets/MBLogo-spwX6zWd.png" alt="" width={60} height={60} />
            </Link>
            {initials && (
              <motion.div
            ...
            <div>
                    ...
                    <div key={item.label}>
                      {item.urlLink ? (
                        <SheetClose asChild>
                          <NavLink
                            to={item.urlLink}
                            className={`flex items-center p-3 gap-4 rounded-lg transition-colors ${
                        ...
                        <motion.div
                          className={`flex items-center p-3 gap-4 cursor-pointer rounded-lg transition-colors ${
                            ...
                            >
                              {item.children?.map((child) => (
                                <SheetClose asChild key={child.title}>
                                  <NavLink
                                    to={child.link}
                                    className="flex items-center p-2 hover:bg-orange-300 rounded-lg transition-colors"
                                  >
              ...
              <SheetClose asChild>
                <button
                  ...
                  className="flex items-center w-full gap-4 p-3 mt-16 hover:bg-orange-300 rounded-lg transition-colors"
                >
                  <LogOutIcon width={25} />
