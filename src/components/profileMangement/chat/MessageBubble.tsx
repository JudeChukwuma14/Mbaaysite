            ...
            <Dialog open={lightboxOpen} onOpenChange={setLightboxOpen}>
              <DialogContent className="max-w-4xl max-h-[90vh] p-0 bg-black border-0">
                <div className="relative flex items-center justify-center h-[80vh]">
                  ...
                  <img
                    src={message.images?.[currentImageIndex] || "/placeholder.svg"}
                    alt={`Image ${currentImageIndex + 1}`}
                    className="max-w-full max-h-full object-contain"
                    crossOrigin="anonymous"
                  />
          ...
          <div className="space-y-2">
            ...
            <div className="flex space-x-2">
              ...
              <Button
                ...
                variant="outline"
                onClick={handleCancelEdit}
                className="text-current border-white/30 hover:bg-white/10 bg-transparent"
              >
                Cancel
              </Button>
            </div>
          ...
          <div className="flex items-end justify-between mt-2 space-x-2">
            ...
            {message.sent && message.type === "text" && !message.isUploading && (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="bg-card border-chat-border" role="menu">
                  <DropdownMenuItem
                    onClick={() => setIsEditing(true)}
                    className="cursor-pointer"
                  >
