...
const Furniture: React.FC = () => {
  ...
  const ImagePart:Subcategory[] = [
    { image: image, text: "Chairs & Stools", link: "/ChairsStools" },
    { image: image, text: "Dresser", link: "/Dresser" },
    { image: image, text: "Tables & Desks", link: "/TablesDesks" },
    { image: image, text: "Sofas & Couches", link: "/SofasCouches" },
    { image: image, text: "Office Furniture", link: "/OfficeFurniture" },
    { image: image, text: "Living Room Furniture", link: "/LivingRoom" },
    { image: image, text: "Outdoor Furniture", link: "/OutdoorFurniture" },
    { image: image, text: "Bedroom Furniture", link: "/BedroomFurniture" },
  ];
