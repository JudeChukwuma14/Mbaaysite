...
import FruitPlants from "@/assets/image/fruitPlant.jpg";
import VegetablePlants from "@/assets/image/VegetablePlants.jpg";
import MedicinalPlants from "@/assets/image/MedicinalPlants.jpg";
import Seeds from "@/assets/image/seed.jpg";
import HerbSeeds from "@/assets/image/Herbseed.jpg";
import FlowerSeeds from "@/assets/image/flowerseed.jpg";
import CulturalTraditionalSeeds from "@/assets/image/CulturalTraditionalSeeds.jpg";
import SeedlingsSaplings from "@/assets/image/SeedingSapling.jpg";
import PlantingKits from "@/assets/image/PlantingKits.jpg";
import PlantCareProducts from "@/assets/image/PlantCare.jpg";
...
const SUBCATEGORIES: Subcategory[] = [
  { image: Plants, link: "/plants", text: "Plants" },
  { image: FruitPlants, link: "/fruit-plants", text: "Fruit Plants" },
  { image: VegetablePlants, link: "/vegetable-plants", text: "Vegetable Plants" },
  { image: MedicinalPlants, link: "/medicinal-plants", text: "Medicinal Plants" },
  { image: Seeds, link: "/seeds", text: "Seeds" },
  { image: HerbSeeds, link: "/herb-seeds", text: "Herb Seeds" },
  { image: FlowerSeeds, link: "/flower-seeds", text: "Flower Seeds" },
  { image: CulturalTraditionalSeeds, link: "/cultural-traditional-seeds", text: "Cultural and Traditional Seeds" },
  { image: SeedlingsSaplings, link: "/seedlings-saplings", text: "Seedlings and Saplings" },
  { image: PlantingKits, link: "/planting-kits", text: "Planting Kits and Tools" },
  { image: PlantCareProducts, link: "/plant-care-products", text: "Plant Care Products" },
];
...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-800">
      No Plants and Seeds Products Found
    </h2>
    ...
    const fetchProducts = async () => {
      try {
        ...
        const filtered = allProducts.filter(
          (product: Product) =>
            product.category?.toLowerCase() === "plants and seeds"
        );
    ...
    >
      <div className="container px-4 py-8 mx-auto sm:px-6 lg:px-8">
        ...
        >
          ...
          <span className="font-medium text-gray-800">Plants & Seeds</span>
        </motion.nav>
