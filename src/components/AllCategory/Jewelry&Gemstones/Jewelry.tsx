...
const SUBCATEGORIES: Subcategory[] = [
  { image: HandmadeJewelry, link: "/handmade-jewelry", text: "Handmade Jewelry" },
  { image: Gemstones, link: "/gemstones", text: "Gemstones" },
  { image: JewelryMaterials, link: "/jewelry-materials", text: "Jewelry Materials" },
  { image: SustainableJewelry, link: "/sustainable-jewelry", text: "Ethically Sourced & Sustainable Jewelry" },
  { image: MenJewelry, link: "/men-jewelry", text: "Men’s Jewelry" },
  { image: ChildrenJewelry, link: "/children-jewelry", text: "Children’s Jewelry" },
  { image: OccasionJewelry, link: "/occasion-jewelry", text: "Bridal & Special Occasion Jewelry" },
  { image: TraditionalJewelry, link: "/traditional-jewelry", text: "Cultural & Traditional Jewelry" },
  { image: GemstoneBirthstone, link: "/gemstone-jewelry", text: "Gemstone Jewelry by Birthstone" },
];
...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-800">
      No Jewelry and Gemstones Products Found
    </h2>
    ...
    >
      <div className="container px-4 py-8 mx-auto sm:px-6 lg:px-8">
        ...
        >
          ...
          <span className="font-medium text-gray-800">Jewelry & Gemstones</span>
        </motion.nav>
