...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Religious Clothing Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub2 ===
            "religious clothing(e.g., traditional muslim attire, hindu wedding saris, christian choir robes)"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          : err.response?.status === 404
            ? "No products found for Religious Clothing. Try again later."
            : "Failed to fetch Religious Clothing products. Please try again.";
