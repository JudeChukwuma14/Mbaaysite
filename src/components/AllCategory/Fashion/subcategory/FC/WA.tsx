...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Wedding Attire Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub2 ===
              "wedding attire(e.g., traditional wedding dresses, groom's outfits, wedding kente)"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          ? "No products found for Wedding Attire. Try again later."
          : "Failed to fetch Wedding Attire products. Please try again.";
