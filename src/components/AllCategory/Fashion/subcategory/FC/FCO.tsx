...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Festival & Ceremony Outfits Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub1 === "cultural & festival clothing" &&
            sub2 ===
              "festival & ceremony outfits(e.g., eid outfits, diwali sarees, traditional new year costumes)"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          ? "No products found for Festival & Ceremony Outfits. Try again later."
          : "Failed to fetch Festival & Ceremony Outfits products. Please try again.";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <FaChevronRight className="text-xs" aria-hidden="true" />
        <Link
          to="/festival-clothing"
          className="transition-colors rounded hover:text-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-400"
        >
         Cultural & Festival Clothing
        </Link>
        <FaChevronRight className="text-xs" aria-hidden="true" />
