...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Handwoven & Local Fabrics Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub2 ===
            "handwoven & local fabrics(e.g., kente cloth, batik fabrics, adire, shweshwe)"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          : err.response?.status === 404
            ? "No products found for Handwoven & Local Fabrics. Try again later."
            : "Failed to fetch Handwoven & Local Fabrics products. Please try again.";
