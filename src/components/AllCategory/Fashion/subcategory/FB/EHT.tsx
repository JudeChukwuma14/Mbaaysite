...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Embroidered & Handmade Textiles Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub2 ===
              "embroidered & handmade textiles(e.g., aso-oke, kantha stitch, brocade)"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          ? "No products found for Embroidered & Handmade Textiles. Try again later."
          : "Failed to fetch Embroidered & Handmade Textiles products. Please try again.";
