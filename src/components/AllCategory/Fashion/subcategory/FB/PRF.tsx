...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Printed Fabrics Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub2 ===
              "printed fabrics(e.g., ankara, wax prints, african prints, ikat )"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          ? "No products found for Printed Fabrics. Try again later."
          : "Failed to fetch Printed Fabrics products. Please try again.";
