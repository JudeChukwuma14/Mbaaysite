...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Headwear & Scarves Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub1 === "footwear & shoes" &&
            sub2 ===
               "headwear & scarves (e.g., turbans, head wraps,geles, kufi caps, hijabs"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          ? "No products found for Headwear & Scarves. Try again later."
          : "Failed to fetch Headwear & Scarves products. Please try again.";
