...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Bags & Pouches Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub1 === "footwear & shoes" &&
            sub2 ===
              "bags & pouches (e.g., handmade leather bagsbeaded clutches, cultural tote bags)"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          ? "No products found for Bags & Pouches. Try again later."
          : "Failed to fetch Bags & Pouches products. Please try again.";
