...
const EmptyState: React.FC = () => (
    ...
    >
        ...
        <h2 className="mb-2 text-2xl font-semibold text-gray-400">
            No Custom Made Ethnic Fashion Products Found
        </h2>
            ...
            try {
                ...
                const filtered = allProducts.filter((product: Product) => {
                    ...
                    return (
                        ...
                        sub2 === "custom-made ethnic fashion ( e.g., tailored kitenge, custom embroidered kaftans )"
                    );
                });
                ...
                const errorMessage = err.message.includes("Network")
                    ...
                    : "Failed to fetch Custom Made Ethnic Fashion products. Please try again.";
