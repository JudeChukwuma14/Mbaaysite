...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Modern Shoes with Cultural Designs Products Found
    </h2>
    ...
    const fetchProducts = async () => {
      try {
        ...
        const errorMessage = err.message.includes("Network")
          ...
          ? "No products found for Modern Shoes with Cultural Designs. Try again later."
          : "Failed to fetch Modern Shoes with Cultural Designs products. Please try again.";
