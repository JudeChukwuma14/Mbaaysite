...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Traditional Shoes & Sandals Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub1 === "footwear & shoes" &&
            sub2 ===
               "traditional shoes & sandals ( e.g., maasai,sandals, babouches, mojaris, espadrilles"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          ? "No products found for Traditional Shoes & Sandals. Try again later."
          : "Failed to fetch Traditional Shoes & Sandals products. Please try again.";
