...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Leather & Handmade Shoes Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub1 === "footwear & shoes" &&
            sub2 ===
            "leather & handmade shoes (e.g.,handcrafted leather shoes,moccasins,traditional slippers)"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          : err.response?.status === 404
            ? "No products found for Leather & Handmade Shoes. Try again later."
            : "Failed to fetch Leather & Handmade Shoes products. Please try again.";
