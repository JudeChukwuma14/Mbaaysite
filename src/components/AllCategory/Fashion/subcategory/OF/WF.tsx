...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Wedding Footwear Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub2 ===
            "wedding footwear(e.g., bridal slippers, beaded sandals, embroidered wedding shoes)"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          : err.response?.status === 404
            ? "No products found for Wedding Footwear. Try again later."
            : "Failed to fetch Wedding Footwear products. Please try again.";
