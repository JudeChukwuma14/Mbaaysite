...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Festival & Ceremony Footwear Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub1 === "cultural footwear for specific occasions" &&
            sub2 ===
             "festival & ceremony footwear(e.g., festival sandals, special occasion moccasins)"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          ? "No products found for Festival & Ceremony Footwear. Try again later."
          : "Failed to fetch Festival & Ceremony Footwear products. Please try again.";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <FaChevronRight className="text-xs" aria-hidden="true" />
        <Link
          to="/occasion-footwear"
          className="transition-colors rounded hover:text-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-400"
        >
         Cultural Footwear For Specific Occasions
        </Link>
        <FaChevronRight className="text-xs" aria-hidden="true" />
