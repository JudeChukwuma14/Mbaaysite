...
const SUBCATEGORIES: Subcategory[] = [
    { image: "https://i.pinimg.com/736x/72/b6/1b/72b61be26e7d9f18e8d94547bc3217a2.jpg", text: "Men’s Traditional Wear", link: "/men-tf-wear" },
    { image: "https://i.pinimg.com/736x/70/61/76/706176a83d9b477d8f68ce2de1a67b2b.jpg", text: "Women’s Traditional Wear", link: "/women-tf-wear" },
    { image: "https://i.pinimg.com/736x/38/19/4f/38194f90eaf9332fbaf98121ac5ee2b1.jpg", text: "Children’s Traditional Wear", link: "/children-tf-wear" },
    { image: "https://i.pinimg.com/736x/9a/67/be/9a67bee73921f0908ca369bbec85e320.jpg", text: "Unisex Traditional Wear", link: "/unisex-tf-wear" },
];
...
const EmptyState: React.FC = () => (
    ...
    >
        ...
        <h2 className="mb-2 text-2xl font-semibold text-gray-800">
            No Traditional Clothing Products Found
        </h2>
            ...
            try {
                ...
                const filtered = allProducts.filter(
                    (product: Product) =>
                        ...
                        product.sub_category?.toLowerCase() === "traditional clothing "
                );
