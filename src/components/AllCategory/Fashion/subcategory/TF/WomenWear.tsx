...
const EmptyState: React.FC = () => (
    ...
    >
        ...
        <h2 className="mb-2 text-2xl font-semibold text-gray-400">
            No Women’s Traditional Wear Products Found
        </h2>
            ...
            try {
                ...
                const filtered = allProducts.filter((product: Product) => {
                    ...
                    return (
                        ...
                        sub2 ===
                        "women’s traditional wear ( e.g., kaftans, kanga, sari, abaya, gele, kimono )"
                    );
                });
                ...
                const errorMessage = err.message.includes("Network")
                    ...
                    : "Failed to fetch Men’s Traditional Wear products. Please try again.";
