...
const EmptyState: React.FC = () => (
    ...
    >
        ...
        <h2 className="mb-2 text-2xl font-semibold text-gray-400">
            No Unisex Traditional Wear Products Found
        </h2>
            ...
            try {
                ...
                const filtered = allProducts.filter((product: Product) => {
                    ...
                    return (
                        ...
                        sub2 ===
                        "unisex traditional clothing ( e.g., sarongs, robes, ponchos, caftans )"
                    );
                });
                ...
                const errorMessage = err.message.includes("Network")
                    ...
                    : "Failed to fetch Unisex Traditional Wear products. Please try again.";
