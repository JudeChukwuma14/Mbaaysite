...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
      No Traditional Embroidery & Design Work Products Found
    </h2>
      ...
      try {
        ...
        const filtered = allProducts.filter((product: Product) => {
          ...
          return (
            ...
            sub1 === "traditional embroidery & design work" &&
            sub2 ===
            "traditional embroidery & design work"
          );
        });
        ...
        const errorMessage = err.message.includes("Network")
          ...
          : err.response?.status === 404
            ? "No products found for Traditional Embroidery & Design Work. Try again later."
            : "Failed to fetch Traditional Embroidery & Design Work products. Please try again.";
