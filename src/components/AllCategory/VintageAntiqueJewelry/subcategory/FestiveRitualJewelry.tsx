        ...
        const fetchHairScalpProducts = async () => {
            try {
                ...
                const filtered = allProducts.filter((product: Product) => {
                    ...
                    return (
                        category === "vintage and antique jewelry" &&
    ...
    return (
        <div className="px-8 py-6">
            <h2 className="mb-6 text-2xl font-bold">
                Festive and Ritual Jewelry
            </h2>
            {products.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                    <FaRegSadTear className="mb-4 text-5xl text-gray-300" />
                    <h2 className="mb-2 text-2xl font-semibold text-gray-400">
                        No Festive and Ritual Jewelry Product Found
                    </h2>
...
export default FestiveRitualJewelry;
