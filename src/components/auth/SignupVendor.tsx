...
const Registration: React.FC = () => {
  ...
  const cities: ICity[] = selectedState ? City.getCitiesOfState(selectedCountry, selectedState) : []
  ...
  return (
    <div className="w-full h-screen">
      ...
      <div className="flex flex-col md:flex-row">
        <Sliding />
        <motion.div style={bg} className="bg-center bg-no-repeat bg-cover w-full min-h-screen px-4 lg:ml-[500px]">
          <div className="flex items-center justify-between px-4 my-6">
            ...
            <div className="hidden w-full text-end lg:block">
              ...
              <Link to={"/login-vendor"} className="text-blue-500 hover:underline">
                <span> Sign in</span>
              </Link>
            </div>
          </div>
          <div className="flex items-center justify-center px-4">
            <div className="pb-10 w-max">
              ...
              <p className="mb-4 text-gray-600">
                We're excited to have you onboard start selling and growing your business with us today!
              </p>
              <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  />
                  {errors.storeName && <p className="text-red-500 text-[10px] mt-1">{errors.storeName.message}</p>}
                </div>
                {/* Email */}
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={inputClass}
                  />
                  {errors.address1 && <p className="text-red-500 text-[10px] mt-1">{errors.address1.message}</p>}
                </div>
                {/* Country */}
                <div>
                ...
                <div>
                  <label className="block mb-2 text-sm font-medium text-gray-700">Store Number</label>
                  <Controller
                    name="storePhone"
                    control={control}
                  ...
                  />
                  {errors.storePhone && <p className="text-red-500 text-[10px] mt-1">{errors.storePhone.message}</p>}
                </div>

                {/* Craft Categories */}
                <div>
                  <label className="block text-sm font-medium text-gray-700">Craft Categories</label>
                  <Controller
                    name="craftCategories"
                    control={control}
                    rules={{ required: "This field is required" }}
                    render={({ field }) => (
                      <select {...field} id="craftCategories" className={selectClass}>
                        ...
                        <option value="Books and Poetry">Books and Poetry</option>
                        <option value="Vintage and Antique Jewelry">Vintage and Antique Jewelry</option>
                        <option value="Home Décor and Accessories">Home Décor and Accessories</option>
                        <option value="Vintage Stocks">Vintage Stocks</option>
                        <option value="Plant and Seeds">Plant and Seeds</option>
                        <option value="Spices, Condiments and Seasonings">Spices, Condiments and Seasonings</option>
                        <option value="Local & Traditional Foods">Local & Traditional Foods</option>
                        <option value="Traditional Clothing and Fabrics">Traditional Clothing and Fabrics</option>
                        <option value="Traditional and Religious Items">Traditional and Religious Items</option>
                      </select>
                    )}
                  />
                  {errors.craftCategories && (
                    <p className="text-red-500 text-[10px] mt-1">{errors.craftCategories.message}</p>
                  )}
                </div>
              ...
              <p className="mt-4 text-center text-gray-600">
                ...
                <Link to="/login-vendor" className="text-orange-500 hover:underline">
                  Sign in
                </Link>
              </p>
            </div>
