...
const EditProfile = lazy(()=>import("@/components/profileMangement/EditProfile"))
const OrderList =lazy(()=>import("@/components/profileMangement/Orderlist"))
const Canclellation =lazy(()=>import("@/components/profileMangement/CancellationForm"))
const Review =lazy(()=>import("@/components/profileMangement/ReviewForm"))
const OrderDetail =lazy(()=>import("@/components/profileMangement/OrderDetail"))
...
const ForgotpasswordMessage = lazy(()=>import("@/components/userAuth/Forgotpasswordmessage"))
const ForgotPassword = lazy(()=>import("@/components/userAuth/Forgotpassword"))
const ResetPassword =lazy(()=>import("@/components/userAuth/ChangePassword"))
...
},
{
  ...
  children: [
    ...
    {path:"/dashboard/canclellation", element:withSuspense(Canclellation)},
...
{path:"forgotpasswordmessage", element:withSuspense(ForgotpasswordMessage)},
